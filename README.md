...
#   Steps to run server                             				               Command Prompt                
1. Open our folder and run the setup file in a terminal.           	     $ python2 setup.py
2. And next, execute this command to run the server.                  	 $ python2 run_server.py RL 4000 1
...
3. In another terminal run the mahimahi network shell of 20 ms.    		   $ mm-delay 20
and run a browser on it.                                  					     $ chromium-browser
4. And in the browser run the webpage                            			    100.64.0.1/test.html
...
# if you want to replace our videos with your own, please take a look at the following instructions
